#############################################################################
# Makefile for building: atccoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Jun 3 16:28:59 2018
# Project:  atccoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile atccoin-qt.pro
#############################################################################
...
Makefile: atccoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile atccoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/atcc/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/atcc/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/atcc/src/leveldb/libleveldb.a: FORCE
	cd C:/atcc/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/atcc/src/leveldb/libleveldb.a && ranlib C:/atcc/src/leveldb/libmemenv.a
