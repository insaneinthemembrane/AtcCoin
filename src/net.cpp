...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AtcCoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"166.62.123.137", "166.62.123.137"},
    {"13.58.37.39", "13.58.37.39"},
    {"154.16.7.213", "154.16.7.213"},
    {"192.169.154.183", "192.169.154.183"},
    {"35.172.8.34", "35.172.8.34"},
    {"43.225.159.181", "43.225.159.181"},
    {"94.23.211.210", "94.23.211.210"},	
     {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AtcCoin is probably already running."), addrBind.ToString().c_str());
        else
